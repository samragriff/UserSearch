...
public static class DataSeeder
{
    public static async Task SeedIfEmptyAsync(IServiceProvider services, CancellationToken cancellationToken = default)
    {
        ...
        var users = new List<User>
        {
            ...
            new() { FirstName = "Lisa", LastName = "Holmes", JobTitle = "Developer", Phone = "07756 896512", Email = "lholmes@test.com" },
            ...
            new() { FirstName = "Gavin", LastName = "Miles", JobTitle = "UX Designer", Phone = "07881 987554", Email = "gmiles@test.com" },
            ...
            new() { FirstName = "Rebecca", LastName = "Bates", JobTitle = "Product Development Manager", Phone = "07798 548733", Email = "rbates@test.com" },
            new() { FirstName = "Hayley", LastName = "Walker-Smith", JobTitle = "Developer", Phone = "07888 932145", Email = "hwalker@test.com" },
            new() { FirstName = "Alexis", LastName = "Crawley", JobTitle = "DevOps Engineer", Phone = "07778 667412", Email = "acrawley@test.com" },
            new() { FirstName = "David", LastName = "Gold", JobTitle = "DevOps Engineer", Phone = "07768 479563", Email = "dgold@test.com" },
